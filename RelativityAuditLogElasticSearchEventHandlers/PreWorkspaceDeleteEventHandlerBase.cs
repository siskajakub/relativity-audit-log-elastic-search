...
{
    [Description("Audit Log Elastic Search Pre Workspace Delete EventHandler")]
    ...
    public class PreWorkspaceDeleteEventHandlerBase : kCura.EventHandler.PreWorkspaceDeleteEventHandlerBase
    {
        ...
        public override kCura.EventHandler.Response Execute()
        {
            ...
            // Get logger
            Relativity.API.IAPILog _logger = this.Helper.GetLoggerFactory().GetLogger().ForContext<PreWorkspaceDeleteEventHandlerBase>();
